...
/** 有效距离:当item的中间x距离屏幕的中间x在LDActiveDistance以内,才会开始放大, 其它情况都是缩小 */
static CGFloat const LDActiveDistance = 150;
/** 缩放因素: 值越大, item就会越大 */
static CGFloat const LDScaleFactor = 0.6;
...
- (NSArray *)layoutAttributesForElementsInRect:(CGRect)rect
{
    ...
    for (UICollectionViewLayoutAttributes *attrs in array) {
        ...
        // 差距越小, 缩放比例越大
        // 根据跟屏幕最中间的距离计算缩放比例
        CGFloat scale = 1 + LDScaleFactor * (1 - (ABS(itemCenterX - centerX) / LDActiveDistance));
